...
public class BulkMuteCommand extends Command {
    ...
    public void onCommand(MessageReceivedEvent e, String[] args) {
        ...
        if (!e.isFromType(ChannelType.PRIVATE)) {
            ...
            if (!matcher.find()) {
                ...
                builder.append(multiLang.getMessage("APP_BULKMUTE_COMM_QUOTES"));
                ...
                if (author.hasPermission(Permission.VOICE_MUTE_OTHERS)) {
                    ...
                    if (voice == null) {
                        MessageBuilder builder = new MessageBuilder();
                        builder.append(e.getAuthor());
                        builder.append(multiLang.getMessage("APP_BULKMUTE_COMM_NO_EXIST_1"));
                        builder.append(matcher.group(1));
                        builder.append(multiLang.getMessage("APP_BULKMUTE_COMM_NO_EXIST_2"));
                        sendMessage(e, builder.build());
                    } else {
                        ...
                        for (Member member : membersInVoice) {
                            try {
                                ...
                                if (ex instanceof InsufficientPermissionException) {
                                    builder.append(multiLang.getMessage("APP_BULKMUTE_COMM_INSUFF_PERMS"));
                                }
                                sendMessage(e, builder.build());
                            }
                        }
                        MessageBuilder builder = new MessageBuilder();
                        builder.append(e.getAuthor());
                        builder.append(multiLang.getMessage("APP_BULKMUTE_COMM_SUCCESS_1"));
                        builder.append(matcher.group(1));
                        builder.append(multiLang.getMessage("APP_BULKMUTE_COMM_SUCCESS_2"));
                        sendMessage(e, builder.build());
                    }
                } else {
                    ...
                    MessageBuilder builder = new MessageBuilder();
                    builder.append(e.getAuthor());
                    builder.append(multiLang.getMessage("APP_BULKMUTE_COMM_CANT"));
                    sendMessage(e, builder.build());
                }
            }
        }
    ...
    public List<String> getAliases() {
        return Arrays.asList("sh!bulkmute", "sh!bm");
    }

    @Override
    public String getDescription() {
        return multiLang.getMessage("APP_BULKMUTE_COMM_DESC");
    }

    @Override
    public String getName() {
        return multiLang.getMessage("APP_BULKMUTE_COMM_NAME");
    }

    @Override
    public List<String> getUsageInstructions() {
        return Arrays.asList(multiLang.getMessage("APP_BULKMUTE_COMM_USAGE"));
    }
